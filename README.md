...
> 
> `aarch64` 아키텍처 대응을 위해 브라우저가 ![js](https://img.shields.io/badge/chrome-_-4285F4?logo=googlechrome)에서 ![js](https://img.shields.io/badge/firefox-_-FF7139?logo=firefoxbrowser)로 교체되었습니다.
> 
